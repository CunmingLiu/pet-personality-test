...
const defaultQuestions = [
  ...
  },
  {
    ...
    title: "你的待办清单通常是？",
    options: [
      { text: "按优先级严格打勾", scoreMap: { borderCollie: 2, shiba: 1 } },
      { text: "有列表但允许变化", scoreMap: { golden: 2, fox: 1 } },
      { text: "想到哪做到哪", scoreMap: { orangeCat: 2, samoyed: 1 } },
      { text: "看心情和体力安排", scoreMap: { deer: 2, rabbit: 1 } },
      { text: "维持稳定固定节律", scoreMap: { britishShorthair: 2, ragdoll: 1 } },
    ],
  },
  {
    qid: "q14",
    order: 14,
    dim: "PET",
    title: "遇到冲突时，你通常会怎么处理？",
    options: [
      { text: "先安抚关系再沟通", scoreMap: { golden: 2, ragdoll: 1 } },
      { text: "直接表达立场", scoreMap: { shiba: 2, borderCollie: 1 } },
      { text: "短暂撤离冷静观察", scoreMap: { fox: 2, britishShorthair: 1 } },
      { text: "敏感但愿意妥协", scoreMap: { rabbit: 2, deer: 1 } },
      { text: "转化成轻松话题", scoreMap: { samoyed: 2, orangeCat: 1 } },
    ],
  },
  {
    qid: "q15",
    ...
    title: "被夸奖后你的第一反应是？",
    options: [
      { text: "马上分享给朋友", scoreMap: { samoyed: 2, golden: 1 } },
      { text: "低调接受继续做事", scoreMap: { britishShorthair: 2, shiba: 1 } },
      { text: "反思哪里还能更好", scoreMap: { borderCollie: 2, fox: 1 } },
      { text: "开心但有点害羞", scoreMap: { rabbit: 2, ragdoll: 1 } },
      { text: "当作小确幸收好", scoreMap: { orangeCat: 2, deer: 1 } },
    ],
  },
  {
    qid: "q16",
    ...
    title: "你更信赖哪类信息？",
    options: [
      { text: "数据和事实证据", scoreMap: { borderCollie: 2, shiba: 1 } },
      { text: "经验与体感判断", scoreMap: { britishShorthair: 2, orangeCat: 1 } },
      { text: "直觉和潜在趋势", scoreMap: { deer: 2, fox: 1 } },
      { text: "他人的真实反馈", scoreMap: { golden: 2, ragdoll: 1 } },
      { text: "灵感触发的想法", scoreMap: { samoyed: 2, rabbit: 1 } },
    ],
  },
  {
    qid: "q17",
    ...
    title: "你认可“成熟”的标准更接近？",
    options: [
      { text: "能负责、能决策", scoreMap: { shiba: 2, borderCollie: 1 } },
      { text: "懂共情、会体谅", scoreMap: { ragdoll: 2, golden: 1 } },
      { text: "有边界也有温度", scoreMap: { britishShorthair: 2, rabbit: 1 } },
      { text: "灵活机敏会变通", scoreMap: { fox: 2, deer: 1 } },
      { text: "乐观稳定不内耗", scoreMap: { orangeCat: 2, samoyed: 1 } },
    ],
  },
  {
    qid: "q18",
    ...
    title: "临近截止日期，你通常会？",
    options: [
      { text: "提前完成，预留缓冲", scoreMap: { borderCollie: 2, britishShorthair: 1 } },
      { text: "按计划稳步推进", scoreMap: { shiba: 2, golden: 1 } },
      { text: "压力下爆发完成", scoreMap: { fox: 2, deer: 1 } },
      { text: "边协作边调整", scoreMap: { ragdoll: 2, samoyed: 1 } },
      { text: "最后冲刺也能交付", scoreMap: { orangeCat: 2, rabbit: 1 } },
    ],
  },
  {
    qid: "q19",
    ...
    title: "你希望生活给你的底色是？",
    options: [
      { text: "温暖连接", scoreMap: { golden: 2, ragdoll: 1 } },
      { text: "掌控与成长", scoreMap: { shiba: 2, borderCollie: 1 } },
      { text: "自由与创意", scoreMap: { fox: 2, deer: 1 } },
      { text: "松弛与满足", scoreMap: { orangeCat: 2, samoyed: 1 } },
      { text: "平静与安全", scoreMap: { britishShorthair: 2, rabbit: 1 } },
    ],
  },
  {
    qid: "q20",
    order: 20,
    dim: "PET",
    title: "如果把你比作宠物伙伴，你更像？",
    options: [
      { text: "总能给人力量的陪伴者", scoreMap: { golden: 2, rabbit: 1 } },
      { text: "有主见的高效行动派", scoreMap: { shiba: 2, borderCollie: 1 } },
      { text: "聪明灵动的点子王", scoreMap: { fox: 2, deer: 1 } },
      { text: "温柔稳定的情绪港湾", scoreMap: { ragdoll: 2, britishShorthair: 1 } },
      { text: "自在可爱的快乐制造机", scoreMap: { orangeCat: 2, samoyed: 1 } },
    ],
  },
];
